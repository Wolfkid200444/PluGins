/**
 * @name Emojify
 * @source https://github.com/wolfkid200444/Plugins/blob/master/Emojify/Emojify.plugin.js
 * @updateUrl https://raw.githubusercontent.com/wolfkid200444/Plugins/master/Emojify/Emojify.plugin.js
 * @website https://github.com/wolfkid200444/Plugins/tree/master/Emojify/Emojify.plugin.js
...
module.exports = (() => {
    ...
    const buildPlugin = ([Plugin, API]) => {
       return class Emojify extends Plugin {
          constructor() {
             super();
          }
          ...
          async start() {
             ...
             commands.register({
                command: 'emojify',
                description: 'Emojify your nessages...',
                usage: '{c} [text to clap on]',
                executor: (args) => ({
                   send: true,
                   result: args.join(' ').toLowerCase().split('').map(Letter => {
